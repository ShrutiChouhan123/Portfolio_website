      ...
      <section id="resume" class="resume">
        <div class="container" data-aos="fade-up">
          ...
          <div class="row" style={{marginLeft:"1rem"}}>
            ...
            I have done 6 months Internship on Python Django.I am currently  Working at Bestpeers Infosystem as Trainee Software Engineer</em></p>
                <p>
                  <ul>
                    <li>Ujjain (M.P)</li>
                    <li>+91 7987162371</li>
                    <li>shchouhan@bestpeers.com</li>
                  </ul>
                </p>
              </div>
